...
def evaluate(val, model, device, test_loader, criterion, args, epoch):
    ## eval accuracy
...
def main():
    ...
    parser.add_argument(
        "--training-mode", type=str, choices=("SimCLR", "SupCon", "SupCE"), default="SimCLR"
    )
    ...
    if args.warmup:
        ...
        for epoch in range(wamrup_epochs):
            ...
            prec1 = evaluate(val, model, device, test_loader, criterion, args, epoch)
